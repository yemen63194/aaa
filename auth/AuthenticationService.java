            ...
            for (Role r:savedUser.getRoles()){
             //   if (r.getName()== TypeRole.PATIENT){
               ...
               // }
                ...
                //}
                if (r.getName() == TypeRole.PATIENT) {
                    String sql = "INSERT INTO patient (user, typatient, archiver, poid, longueur, datede_nais, sexe) VALUES (?, ?, ?, ?, ?, ?, ?)";
                ...
                if (r.getName()==TypeRole.CUISINIER){
                    String sql = "INSERT INTO Cuisinier (user, nom, prenom, date_ajout, sexe, salaire, disponiblee) VALUES (?, ?, ?, ?, ?, ?, ?)";
